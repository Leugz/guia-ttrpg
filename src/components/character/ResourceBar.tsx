...
export function ResourceBar({ label, current, max, colorClass, onClick }: ResourceBarProps) {
  return (
    <div
      onClick={onClick}
    ...
    >
      <span className={`block text-xs font-bold uppercase tracking-wider ${colorClass}`}>
        {label}
      </span>
